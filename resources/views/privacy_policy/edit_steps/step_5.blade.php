                    ...
                    <div class="panel-body">
                        {!! Form::open(['route' ->['privacy-policy.postStep', 5], 'class'=> 'form-horizontal', 'role' => 'form']]) !!}
                          ...
                          <div class="checkbox">
                            ...
                            <div class="checkbox">
                              @foreach ($policy_share_circumstances_selected as $share_circumstance_selected)
                                @if ($share_circumstance_selected->share_circumstance_id == $personal_info->id)
                                  {!! Form::checkbox($share_circumstance->circumstance, $share_circumstance->id, true) !!} 
                                @else
