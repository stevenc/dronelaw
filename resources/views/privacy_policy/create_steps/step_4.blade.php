            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #f5f5f5;"><h3>UAV Specific Website Agreements - Privacy Policy - Step 3</h3></div>
                    <div class="panel-body">
                        {!! Form::open(['action' ->['PrivacyPolicyController@getStep', 4], 'class'=> 'form-horizontal', 'role' => 'form']]) !!}
                          <p>
                          ...
                          <div class="checkbox">
                            {!! Form::label($check_box->use, $check_box->use) !!}       
                          </div>
                            <div class="checkbox">
                              {!! Form::checkbox($check_box->use, $check_box->id) !!} 
                            </div>
                          @endforeach
