            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #f5f5f5;"><h3>UAV Specific Website Agreements - Copyright Policy</h3></div>
                    <div class="panel-body">
                        {!! Form::open(['route' => ['copyright-policy.update', $copyright_policy->id], 'method' => 'put', 'class'=> 'form-horizontal', 'role' => 'form']) !!}
                          <p>
                          ...
                          @else
                            <div class="radio">
                              <label>
                                <input type="radio" name="options_dmca" id="options_dmca1" value="0">
                                Retain Traverse Legal
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="options_dmca" id="options_dmca1mca2" value="1" checked>
                                Act as your own DMCA agent
                              </label>
                            </div>
                          @endif
